...
/*===========================
    ...
    if (startIndex !== -1) {
      ...
      proValue = url.substring(startIndex + 5, endIndex);
    
      console.log("La palabra capturada es: " + proValue);
    } else {
    ...
    /*===========================
        ...
        if(catValue ==null || proValue == null || yearValue==null){
...
for(var j=0; j<listNP.length;j++){
  ...
  if(proValue != null){
    if(proValue == listNP[j].nombre_producto){
        nameProducto = listNP[j].nombre_producto;
...
console.log("nameProducto "+nameProducto);
